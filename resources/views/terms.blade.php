...
@section('content')
    ...
    <section class="inner-page">
        <div class="container">
            <h4>This page is an agreement between the first party (the user) and the second party (the administration) regarding everything related to the use of the site, privacy policies and profits:</h4>
            <h6 style="color:#d0801e;">When changing or adding any clause of the agreement, the first party will be notified through the website itself and through the email registered on our website.</h6>
            <ul>
                <li>The first Rule - new user:</li>
                <p>
                    The process of registering on our adshub site is very simple and you must set a special mail for a paypal account or a mobile number for the Vodafone network at first
                    To ensure smooth sending and receiving of money through our website - your balance starts at zero (0) and you can then add credit via PayPal
                    Or Vodafone Cash in the ways that will appear in the agreement after that, or by profiting from watching ads through our website.
                </p>
                <li>The second Rule - Sending money to your account on our website:</li>
                <p>
                    Currently, there are two payment methods for our website: Vodafone Cash and PayPal - Vodafone Cash. You must request an additional amount through our website first, and the amount will be suspended until it reaches
                    To the number 01019742029 and from the same number that you entered when registering to ensure identity and in the event that the amount was sent and the comment was not canceled within 48 hours
                    You can contact our support to find out the problem and add the balance - the same thing applies to the Paypal account. You can send the balance after request it to mail
                    h.dabour25@yahoo.com, and within 48 hours, the balance will finally appear to your account on our website.
                </p>
